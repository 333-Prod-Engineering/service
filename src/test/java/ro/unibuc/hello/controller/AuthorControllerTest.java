...
public class AuthorControllerTest {
    ...
    void test_PostAuthor() throws Exception {
        // Given
        var authorCreationRequestDto = AuthorCreationRequestDto.builder().name("Ion Creanga").nationality("romanian")
                .birthDate(LocalDate.of(1837, 03, 1)).deathDate(LocalDate.of(1889, 12, 31))
                .build();
    ...
    void test_PatchAuthor() throws Exception {
        // Given
        var authorId = "1";
        var authorUpdateRequestDto = AuthorUpdateRequestDto.builder().deathDate(LocalDate.of(1899, 12, 31)).build();
    ...
    @Test
    void test_DeleteMapping() throws Exception {
        // Given
